//player_selectSlot = compile preprocessFileLineNumbers "scripts\Buildables\ui_selectSlot.sqf"; //not needed, deploy anything mod
//fnc_usec_selfActions = compile preprocessFileLineNumbers "scripts\fn_selfActions.sqf"; //not needed, zsc, vkc & deployanything
