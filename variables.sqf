...
_MiscLarge = ["Land_Ind_TankSmall","Land_Misc_ConcBox_EP1","MAP_AirCond_big","MAP_AirCond_small","MAP_AirCondition_A","MAP_AirCondition_B","MAP_bouda_plech","MAP_drevo_hromada","MAP_kasna_new","MAP_kulna","MAP_Misc_Greenhouse","MAP_Misc_Hutch","MAP_PowerGenerator","Pile_of_wood","MAP_Misc_WoodPile","MAP_Ladder","MAP_P_Ladder","MAP_LadderHalf","MAP_P_LadderLong"];
...
_Towers = ["MAP_vez"];
_Communication = ["MAP_antenna_small_roof","MAP_antenna_small_roof_1","MAP_antenna_big_roof","MAP_Antenna","MAP_Vysilac_FM","MAP_telek1"];
...
_Topaz = _Defenses + _Forts + _Tents + _Towers + _Communication + _Garage + _fuel + _Mounted_Weapons;
plotAmplifiers = _Communication;
...
_RoadsStructures = ["MAP_Misc_Drainage","MAP_bridge_asf1_25","MAP_Bridge_stone_asf2_25","MAP_Bridge_wood_25","MAP_Dam_Barrier_40","MAP_Dam_Conc_20","MAP_Dam_ConcP_20"];
_Transportation = _RoadsAsphalt1 + _RoadsAsphalt2 + _RoadsAsphalt3 + _RoadsGravel + _RoadsIntersect + _RoadsMud + _RoadsPaved + _RoadsRunways + _RoadsStructures;
publicTransportation = _Transportation - _RoadsStructures;
