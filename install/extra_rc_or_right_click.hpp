...
class ExtraRc {
  ...
  class ItemPickAxe {
    class Remove_Road {
      text = "Remove Road";
      script = "closeDialog 0;execVM 'scripts\buildables\doadDismantle.sqf';";
    };
  };	
};
...
["ItemPickAxe","Remove Road","closeDialog 0;execVM 'scripts\buildables\doadDismantle.sqf';","true"]
